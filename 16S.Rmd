...
beta_dmm <- create_ordination_plots(ps_obj, method = "PCoA", distance_method = distance_method , group = "best", size = 15,palette)

size=c(3,2)

p <- ggarrange(ggarrange(beta_dmm,labels='A'),plots_dmm,ncol=2)
ggsave("./figures/dmm_beta.png",p,dpi=300,height = 10,width=20)
